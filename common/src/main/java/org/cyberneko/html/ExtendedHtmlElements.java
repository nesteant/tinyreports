 ...
 */
public class ExtendedHtmlElements {
	//
	// Constants
	//
	...
	public static final short BOOKMARKS = BODY+1;
	public static final short BOOKMARK = BOOKMARKS+1;
	public static final short BR = BOOKMARK+1;
	...
	static {
		...
		ELEMENTS_ARRAY['B'-'A'] = new Element[] {
				...
				new Element(BOOKMARKS, "BOOKMARKS", Element.SPECIAL, HEAD, null),
				new Element(BOOKMARK, "BOOKMARK", Element.SPECIAL, new short[]{BOOKMARKS, BOOKMARK}, null),
				// BR - O EMPTY
